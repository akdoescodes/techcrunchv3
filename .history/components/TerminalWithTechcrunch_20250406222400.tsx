...
export default function TerminalWithTechcrunch() {
  ...
  return (
    <div className="relative w-full px-4 py-10 flex items-center justify-center overflow-hidden">
      <div
        ref={terminalRef}
        className="relative flex flex-col justify-start rounded-lg border border-purple-700 shadow-[0_0_2px_#a855f766] backdrop-blur-sm text-gray-200 font-mono text-sm px-6 pt-6 pb-4 z-10 overflow-hidden"
        style={{
      ...
      >
        ...
        <h1
          className="font-extrabold bg-clip-text text-transparent text-center w-full mb-6 z-10"
          style={{
        ...
        {/* Background glowing orbs (placed outside view box) */}
