...
// Customize here 👇
const TERMINAL_WIDTH = "42rem"; // Adjust terminal size
const TECHCRUNCH_TEXT_SIZE = "4.2rem"; // Adjust TECHCRUNCH font size
  ...
  return (
    <div className="relative w-full px-4 py-10 flex items-center justify-center overflow-hidden">
      <div
        ...
        style={{ width: TERMINAL_WIDTH, backgroundColor: "#ffffff0a" }}
      >
        {/* Top gradient bar */}
