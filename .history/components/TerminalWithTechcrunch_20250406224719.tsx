...
export default function TerminalWithTechcrunch() {
  ...
  return (
    <div className="relative w-full px-2 py-4 flex items-center justify-center overflow-hidden">
      <div
        ref={terminalRef}
        className="relative flex flex-col justify-start w-full max-w-[90%] sm:max-w-[600px] md:max-w-[720px] lg:max-w-[800px] min-h-[280px] px-4 pt-6 pb-6 rounded-xl border border-purple-700 shadow-[0_0_2px_#a855f766] backdrop-blur-sm text-gray-200 font-mono text-xs z-10 bg-white/5 overflow-hidden"
      >
        {/* Top gradient bar */}
        ...
        {/* TECHCRUNCH title */}
        <h1
          className="text-2xl sm:text-3xl md:text-4xl lg:text-[3.5rem] font-extrabold bg-clip-text text-transparent text-center w-full mb-4 leading-tight z-10"
          style={{
