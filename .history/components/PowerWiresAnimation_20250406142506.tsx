...
const HelixWire = ({
  ...
  const geometry = useMemo(() => new THREE.TubeGeometry(path, 200, thickness, 16, false), [path, thickness])
  const material = useMemo(() => new THREE.MeshStandardMaterial({ color, emissive: color, emissiveIntensity: 0.5 }), [color])
...
const EnergyCore = () => {
  ...
  return (
    <mesh ref={meshRef}>
      ...
      <meshStandardMaterial emissive="#A855F7" emissiveIntensity={1} color="#A855F7" />
    </mesh>
  )
}
