...
export default function TechcrunchParticles() {
  ...
  return (
    <div
      ref={containerRef}
      className="w-full h-[220px] md:h-[260px] lg:h-[300px] flex items-center justify-center relative overflow-hidden bg-transparent"
    >
      <h1
        className="text-3xl md:text-6xl lg:text-7xl font-extrabold bg-clip-text text-transparent typing-animation tech-font z-10"
        style={{
