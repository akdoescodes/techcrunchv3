...
function MetallicTechcrunch() {
  ...
  const textures = useTexture({
    roughnessMap: 'https://threejs.org/examples/textures/terrain/roughnessmap.jpg',
    normalMap: 'https://threejs.org/examples/textures/terrain/normalmap.jpg',
    metalnessMap: 'https://threejs.org/examples/textures/terrain/specularmap.jpg'
  })
