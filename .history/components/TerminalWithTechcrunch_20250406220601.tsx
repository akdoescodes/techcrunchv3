...
const TERMINAL_WIDTH = "42rem"; // tweak this if needed
const TERMINAL_HEIGHT = "auto";
  ...
  return (
    <div className="relative w-full px-4 py-10 flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        {/* Centered TECHCRUNCH text */}
        <h1
          className="text-4xl md:text-5xl font-extrabold bg-clip-text text-transparent tech-font mb-6 text-center"
          style={{
        ...
        {/* Terminal output */}
        <div className="text-purple-300 mb-4 z-10 text-left">
