...
export default function TerminalWithTechcrunch() {
  ...
  useEffect(() => {
    ...
    // Create ring centered in container
    const ring = new Ring(
      { x: containerCenterX, y: containerCenterY, z: 0 },
      Math.min(containerRect.width, containerRect.height) * 0.4, // Adjust radius as needed
