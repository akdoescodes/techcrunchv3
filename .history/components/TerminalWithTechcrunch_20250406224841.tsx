...
const TECHCRUNCH_TEXT_SIZE = "3.5rem";
...
export default function TerminalWithTechcrunch() {
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center px-4">
      <div
        ref={terminalRef}
        className="relative flex flex-col justify-center items-center w-full max-w-[90%] sm:max-w-[600px] md:max-w-[720px] lg:max-w-[800px] min-h-[280px] px-4 pt-6 pb-6 rounded-xl border border-purple-700 shadow-[0_0_2px_#a855f766] backdrop-blur-sm text-gray-200 font-mono text-xs z-10 bg-white/5 overflow-hidden"
      >
        {/* Top gradient bar */}
        ...
        {/* Main content (title + terminal output) */}
        <div className="flex flex-col justify-center items-center flex-grow w-full h-full z-10">
          {/* TECHCRUNCH title */}
          <h1
            className="font-extrabold bg-clip-text text-transparent text-center w-full mb-4 leading-tight"
            style={{
