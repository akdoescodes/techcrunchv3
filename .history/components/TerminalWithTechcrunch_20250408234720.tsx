...
export default function TerminalWithTechcrunch() {
  ...
  return (
    <div
      ref={containerRef}
      className="w-full flex flex-col items-center px-4 py-4 sm:py-6 md:py-10 overflow-hidden relative"
    >
      <div
        ref={terminalRef}
        className="relative flex flex-col justify-start items-center rounded-lg border border-purple-700 shadow-[0_0_2px_#a855f766] backdrop-blur-sm text-gray-200 font-mono text-sm px-4 sm:px-6 pt-10 pb-10 z-10 w-full max-w-[700px] bg-[rgba(255,255,255,0.05)] overflow-hidden mb-4"
      ...
      {/* Event Card - Placed directly below terminal */}
      <div className="w-full max-w-[700px] bg-[rgba(255,255,255,0.05)] rounded-lg border border-gray-700 p-4">
        <p className="text-gray-200">Your event content goes here</p>
      </div>
    </div>
  );
}