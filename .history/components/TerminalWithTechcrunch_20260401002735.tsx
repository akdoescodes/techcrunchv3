...
export default function TerminalWithTechcrunch() {
  ...
  return (
    <div
      ref={containerRef}
      className="w-full min-h-[calc(80vh-4rem)] flex items-center justify-center overflow-hidden relative px-4 py-2 sm:py-12 md:py-16 lg:py-20"
    >
      <div
        ref={terminalRef}
      ...
      >
        ...
        <div className="text-left w-full space-y-1 z-10 text-sm md:text-base">
          ...
          <p className="text-green-600 font-semibold">Found 5 mind-blowing events!</p>
        </div>
