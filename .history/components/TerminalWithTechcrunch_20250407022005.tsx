...
export default function TerminalWithTechcrunch() {
  ...
  useEffect(() => {
    ...
    const center = {
      x: (terminal.offsetLeft + terminal.offsetWidth  / 2) + -30,
      y: (terminal.offsetTop + terminal.offsetHeight / 2)+ -4REN,
    ...
    const ring = new Ring(center, 400, { x: 90, y: 0, z: 30}, 100, container);
