...
const ringRotationSpeeds = [0.05, 0.03, 0.04, 0.02]; // Increased rotation speeds
...
export default function TerminalWithTechcrunch() {
  ...
  // Simplified position calculation for particles on rings
    ...
    const animate = () => {
      if (isTurboMode) {
        ...
        outsideParticlesRef.current.forEach(particle => {
          ...
          particle.el.style.transform = `scale(${1 + Math.sin(ringRotations[particle.ringIndex]) * 0.1})`;
        });
      }
