...
export default function TerminalWithTechcrunch() {
  ...
  useEffect(() => {
    ...
    const center = {
      x: terminal.offsetLeft + terminal.offsetWidth  +2  / 2,
      y: terminal.offsetTop + terminal.offsetHeight + 2/ 2,
      z: 0,
    };



    const ring = new Ring(center, 400, { x: 90, y: 0, z: 35}, 100, container);
