    ...
    const animate = (timestamp: number) => {
      ...
      this.particles.forEach((p, i) => {
        ...
        p.el.style.transform = `
          translate(${wobbleX + orbitX}px, ${wobbleY + orbitY}px) 
          scale(${0.8 + easedProgress * 0.4})
  ...
  startContinuousAnimation() {
    ...
    const animateContinuous = (timestamp: number) => {
      ...
      this.particles.forEach(p => {
        ...
        p.el.style.transform = `
          translate(${wobbleX + orbitX}px, ${wobbleY + orbitY}px) 
          scale(${1 + Math.sin(timestamp * 0.001) * 0.1})
        `;
...
export default function TerminalWithTechcrunch() {
  ...
  const ringConfigs = [
    { radius: 460, count: 80, speed: 1.2, spinSpeed: 0.1 },
    { radius: 300, count: 60, speed: 1.0, spinSpeed: -0.15 },
    { radius: 550, count: 50, speed: 0.8, spinSpeed: 0.08 },
    { radius: 380, count: 70, speed: 1.1, spinSpeed: -0.12 },
  ];
      ...
      >
        ...
        <h1
          ...
          style={{
            ...
            animation: isHovered ? "subtlePulse 4s infinite ease-in-out" : "none"
          }}
        >
          TECHCRUNCH
        </h1>
