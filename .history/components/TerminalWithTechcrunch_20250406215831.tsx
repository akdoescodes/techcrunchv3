...
import Techcrunch3D from "@/components/Techcrunch3D"; // Adjust if needed
...
export default function TerminalWithTechcrunch() {
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      {/* 🧠 Glowing TECHCRUNCH Hero Text */}
      <h1
        className="text-4xl md:text-7xl lg:text-8xl font-extrabold bg-clip-text text-transparent tech-font z-10"
        style={{
      ...
      {/* ✨ Terminal-like sub-container */}
      <div className="relative mt-8 max-w-2xl w-full bg-[#ffffff0a] border border-purple-700 rounded-lg p-4 font-mono text-sm text-gray-200 text-left shadow-[0_0_2px_#a855f766] backdrop-blur-sm z-10">
