...
const NUCLEUS_RADIUS = 80; // Smaller orb size
...
export default function TerminalWithTechcrunch() {
  ...
  useEffect(() => {
    ...
    nucleusCenterRef.current = {
      x: terminalRect.width / 2, // Perfectly centered
      y: terminalRect.height / 2, // Perfectly centered
      z: 0
    };
  ...
  const startNucleusFormation = () => {
    ...
    setTimeout(() => {
      ...
      const radius = NUCLEUS_RADIUS * 0.7; // Smaller nucleus
      ...
      particles.forEach((particle, i) => {
        ...
        }, i * 10); // Procedural delay
      });

      // Start nuclear animation
  ...
  const startNuclearAnimation = () => {
    ...
    const animate = () => {
      ...
      particles.forEach((particle, i) => {
        ...
        // Color cycling for nuclear effect
  ...
  return (
    <div
      ref={containerRef}
      className="w-full min-h-screen flex items-center justify-center overflow-hidden relative px-4 py-10 bg-white"
      style={{ perspective: "1000px", transformStyle: "preserve-3d" }}
    >
      <div
        ref={terminalRef}
        className="relative flex flex-col justify-start items-center rounded-xl border border-gray-200 shadow-lg text-gray-800 font-mono text-sm px-8 pt-12 pb-12 z-10 transition-all duration-500"
        style={{
          width: "100%",
          maxWidth: "800px",
      ...
      >
        ...
        {/* TECHCRUNCH text */}
        <h1
          className="font-extrabold bg-clip-text text-transparent text-center w-full mb-8 leading-tight z-1000 relative"
          style={{
