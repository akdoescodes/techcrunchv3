...
const TECHCRUNCH_TEXT_SIZE = "clamp(1rem, 8vw, 7rem)";
...
export default function TerminalWithTechcrunch() {
  ...
  return (
    <div
      ref={containerRef}
      className="w-full min-h-[calc(100vh-4rem)] flex items-center justify-center overflow-hidden relative px-4 py-8 sm:py-12 md:py-16 lg:py-20"
    >
      <div
        ref={terminalRef}
