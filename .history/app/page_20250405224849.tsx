  ...
  const [events, setEvents] = useState<EventInfo[]>([
    {
      ...
      additionalInfo:
        "Bring your laptop with Python installed. We'll be working with pandas, numpy, and scikit-learn.",
    ...
    },
    {
      ...
      additionalInfo:
        "Early bird tickets available until March 31. Includes lunch and conference materials.",
    ...
    },
    {
      ...
      additionalInfo:
        "Teams of up to 4 people. Food and drinks provided. Prizes for the top 3 projects.",
    ...
    },
    {
      ...
      additionalInfo:
        "Intermediate Python knowledge required. GPUs will be provided for training exercises.",
      ...
      <div className="relative z-20">
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            {/* Terminal intro with 3D animation */}
            <div className="mt-6 max-w-2xl mx-auto bg-[#ffffff] border border-purple-700 rounded-lg p-4 font-mono text-sm text-gray-200 text-left shadow-[0_0_20px_#a855f766] backdrop-blur-sm relative overflow-hidden">
              ...
              <div className="relative w-full h-[300px] flex items-center justify-center">
                <h1 className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-pink-500 z-10">
                  TECHCRUNCH
                </h1>
                <div className="absolute top-1/2 left-1/2 w-3 h-3 bg-yellow-400 rounded-full animate-ellipse-slow transform -translate-x-1/2 -translate-y-1/2" />
              </div>
            </div>
          </div>
