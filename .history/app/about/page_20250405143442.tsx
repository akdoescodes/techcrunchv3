...
export default function About() {
  ...
  return (
    <main className="min-h-screen relative overflow-hidden bg-gradient-to-br from-white via-blue-50 to-purple-100 text-gray-900">
      <DataParticles />
      <Navbar adminState={adminState} setAdminState={setAdminState} />

      {/* ✅ Animated Grid Background */}
      <div className="fixed inset-0 -z-10 pointer-events-none">
        <div className="w-full h-full bg-grid animate-grid" />
      </div>
