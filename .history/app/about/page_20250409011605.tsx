...
import teamMember1 from "@/assets/me@0.33x.png"
import teamMember2 from "@/assets/6ec05b68-0e34-49a9-bfeb-91928d030b2a.jpeg"
            ...
            <div className="p-6 md:p-10 space-y-10">
              ...
              <div className="bg-white bg-opacity-20 border border-purple-200 backdrop-blur-lg p-4 font-mono rounded-xl text-sm shadow-inner">
                <div className="flex items-center mb-2 space-x-2">
                  ...
                  <span className="text-xs text-gray-600">Tech Team.md</span>
                </div>
