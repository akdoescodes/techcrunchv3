            ...
            <div className="p-6 md:p-10 space-y-10">
              ...
              <section>
                ...
                <div className="bg-white bg-opacity-30 border border-purple-200 rounded-xl p-4 shadow-inner mt-5">
                  <p className="text-gray-800 mb-4">Have questions or suggestions? We'd love to hear from you!</p>
                  <div className="space-y-1 font-mono">
                  <p><span className="text-purple-500">Name:</span></p>
                    <p><span className="text-purple-500">Email:</span>Himanshu Vaidya – 9322096802 </p>
                    <p><span className="text-purple-500">Phone:</span></p>
                ...
                <div className="bg-white bg-opacity-30 border border-purple-200 rounded-xl p-4 shadow-inner mt-5">
                  <p className="text-gray-800 mb-4">Have questions or suggestions? We'd love to hear from you!</p>
                  <div className="space-y-1 font-mono">
                  <p><span className="text-purple-500">Name:</span>Vansh </p>
