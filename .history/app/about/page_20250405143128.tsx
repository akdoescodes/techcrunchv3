...
export default function About() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-purple-100 text-gray-900 relative">
      <DataParticles />
      <Navbar adminState={adminState} setAdminState={setAdminState} />
      <div className="absolute inset-0 -z10 overflow-hidden">
          <div className="w-full h-full bg-grid animate-grid"></div>
      </div>
          ...
          <div className="p-6 md:p-10 space-y-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white bg-opacity-30 border border-purple-200 rounded-xl p-5 shadow-inner">
                  ...
                  <ul className="space-y-2 text-gray-800">
                    ...
                    <li>📝 Register via integrated forms</li>
            ...
            <section>
              ...
              <div className="bg-white bg-opacity-30 border border-purple-200 rounded-xl p-4 font-mono text-sm text-gray-700 shadow-inner">
                ...
                <p><span className="text-green-600">Storage:</span> LocalStorage, Static JSON</p>
                <p><span className="text-green-600">Animation:</span> Canvas API, Framer Motion</p>
                <p><span className="text-green-600">Integration:</span> Google Forms API</p>
              </div>
            </section>
