...
import TechcrunchAura from '@/components/TechcrunchAura';
import SimulationMaterial from "@/components/SimulationMaterial"
import vertexShader from "!!raw-loader!@/components/vertexShader.glsl";
import fragmentShader from "!!raw-loader!@/components/fragmentShader.glsl";
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen text-black overflow-hidden">
      ...
      {/* Add the TechcrunchAura component */}
           <SimulationMaterial />
        </div>
