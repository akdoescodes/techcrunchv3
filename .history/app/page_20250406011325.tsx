    ...
    <main className="relative min-h-screen text-black overflow-hidden">
      ...
      <div className="relative z-20">
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="relative w-[200px] h-full" onMouseMove={handleLight}>
  <div
    ref={lightRef}
    className="absolute w-[400px] h-[400px] rounded-full bg-gradient-to-br from-white via-white/80 to-transparent opacity-20 pointer-events-none"
  />
</div>
