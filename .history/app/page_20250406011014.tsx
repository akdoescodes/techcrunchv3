    ...
    <main className="relative min-h-screen text-black overflow-hidden">
      ...
      <div className="relative z-20">
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="absolute left-4 top-10 h-[80vh] w-[120px] bg-white/20 backdrop-blur-md rounded-xl shadow-xl shadow-black/5 animate-floatSlow" />
<div className="absolute right-4 top-20 h-[80vh] w-[120px] bg-white/20 backdrop-blur-md rounded-xl shadow-xl shadow-black/5 animate-floatSlow" />
