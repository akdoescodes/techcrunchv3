  ...
  return (
    <main className="relative min-h-screen text-black overflow-hidden">
      ...
      <div className="relative z-20">
        ...
        {/* Terminal with minimal spacing */}
        <div className="w-full flex justify-center px-1 mt-0">
          <TerminalWithTechcrunch />
        </div>

        {/* Event cards with tight spacing */}
          ...
          <div ref={ref}>
            {editingEvent ? (
              ...
              <motion.div
                ...
                className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6 md:gap-8"
              >
