      ...
      <div className="relative z-20">
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <div className="mt-6 max-w-2xl mx-auto bg-[#0f0f11] border border-purple-700 rounded-lg p-4 font-mono text-sm text-gray-200 text-left shadow-[0_0_20px_#a855f766] backdrop-blur-sm">
