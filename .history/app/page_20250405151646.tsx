  ...
  return (
    <main className="relative min-h-screen text-black overflow-hidden">
      ...
      <div className="relative z-20">
        ...
        {/* Footer */}
        <footer className="bg-gray-900 border-t border-gray-800 py-8 mt-12 relative z-20">
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="text-gray-400 font-mono text-sm">
                &copy; {new Date().getFullYear()} DataTech Events | <span className="text-purple-400">v1.0.0</span>
              </div>
            </div>
          </div>
        </footer>
