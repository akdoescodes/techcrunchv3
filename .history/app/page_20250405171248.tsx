      ...
      <div className="relative z-20">
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <div className="mt-6 max-w-3xl mx-auto bg-gradient-to-br from-white via-gray-100 to-purple-50 border border-purple-200 rounded-xl p-6 font-mono text-sm text-gray-800 text-left shadow-xl backdrop-blur-md relative overflow-hidden">
              ...
              <p className="text-purple-600">Crunching data...</p>
              <p className="text-green-700">Found 6 mind-blowing tech events in your area!</p>
            </div>
          </div>
