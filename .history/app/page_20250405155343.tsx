      ...
      <div className="relative z-20">
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <div className="mt-6 max-w-2xl mx-auto bg-white/30 backdrop-blur-md border border-white/20 rounded-lg p-4 font-mono text-sm text-gray-800 text-left shadow-lg">
              ...
              <div className="relative z-10 flex justify-center items-center h-[300px] bg-transparent">
                <h1 className="glass-tech-text relative text-5xl md:text-7xl font-extrabold tracking-tight">
                  <span className="animated-gradient typing-text">DATATECH</span>
                  <span className="glow-underline"></span>
                </h1>
              </div>
              <p><span className="text-green-600">user@datatech</span>:<span className="text-blue-500">~</span>$ find events --category="data-science" --sort="date"</p>
