...
export default function Home() {
  ...
  // Animation hooks for background effect
  const bgAnimation = useMotionValue(0)
  const bgOpacity = useTransform(bgAnimation, [0, 1], [0.1, 0.3])
  const bgSize = useTransform(bgAnimation, [0, 1], ["90%", "95%"])

  useEffect(() => {
    const sequence = async () => {
      while (true) {
        await animate(bgAnimation, 1, {
          duration: 4,
          ease: "easeInOut"
        })
        await animate(bgAnimation, 0, {
          duration: 4,
          ease: "easeInOut"
        })
      }
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-20 relative">
            ...
            <motion.div
              ...
              className="absolute inset-0 mx-auto my-auto bg-gradient-to-br from-purple-500/10 via-pink-500/10 to-purple-500/10 rounded-xl blur-xl -z-10"
              animate={{
            ...
            {/* Your existing terminal - completely unchanged */}
