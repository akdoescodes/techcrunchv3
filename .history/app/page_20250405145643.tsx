...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-white text-gray-800">
      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Discover cutting-edge data science and tech events.
            ...
            {/* Terminal Block */}
            <div className="mt-6 max-w-2xl mx-auto bg-white/70 backdrop-blur border border-gray-200 rounded-lg p-4 font-mono text-sm text-gray-700 shadow-md text-left">
        ...
        {/* Footer */}
        <footer className="bg-white border-t border-gray-300 py-8 mt-12 text-center">
