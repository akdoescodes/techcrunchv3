...
export default function Home() {
  ...
  <span className="text-xs text-purple-400 ml-2">terminal v.2025</span>
              ...
              <p>
                <span className="text-green-600">user@techcrunch</span>:<span className="text-blacktext-gray-900">$ find
                events --category="tech" --sort="date"~</span>
              </p>
              <p className="text-pink-500 animate-pulse">Crunching data...</p>
<p className="text-green-600 font-semibold">Found 6 mind-blowing tech events in your area!</p>
