...
export default function Home() {
  const [events, setEvents] = useState<EventInfo[]>([
      ...
      },
      {
        ...
        contactInfo: "Sujal Gonde ~ 8483077337 | Meghanshu Atram ~ 9309274116 | Vivek Hanwat ~ 7058379915",
        registrationLink: "",
        organizer: "Department of Data Science, GH Raisoni College of Engineering & Management, Nagpur",
        additionalInfo: "Match format: 5 overs per innings. Rules will be explained on match day.",
        speakers: [],
      ...
      },
      {
        ...
        contactInfo: "Nayan Dadulkar ~ 9309532459 | Prajwal Maidpawar ~ 9834047813 | Hitesh Rinayat ~ 8645607876",
        registrationLink: "https://campus-innovate-hackathon.vercel.app/",
        organizer: "Department of Data Science – Code Crafter Club",
        capacity: "2-4 members per team",
        additionalInfo: "Team size: 2 – 4 members.",
        speakers: [],
        technologies: ["Innovation", "Coding", "Product Development"],
      },
      {
        id: "9",
        date: "April 7, 2026",
        ...
        contactInfo: "Gauri Dakhole ~ 8390040969 | Diksha Zode ~ 9370760735 | Devyani Dhote ~ 8766422518",
        registrationLink: "",
        organizer: "Department of Data Science – DATATRON",
        additionalInfo: "Solo and duo participation available.",
        speakers: [],
        technologies: ["Debate", "Creativity", "Fun"],
      }
  ]);
