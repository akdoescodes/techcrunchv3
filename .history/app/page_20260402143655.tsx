...
export default function Home() {
  const [events, setEvents] = useState<EventInfo[]>([
      ...
      },
      {
        ...
        description:
          "Unleash your creativity at COLOR CAPTURE! Explore the campus, find the assigned color, and capture stunning photos where the main subject represents that color. This exciting race against time tests your observation and photography skills.",
        entryFee: "₹30 per solo, ₹50 per duo",
        contactInfo:
          "Atharva Khaire ~ 7083584566 | Rahul Singh ~ 7030804822 | Amol Rahangdale ~ 8766608831",
        registrationLink: "https://docs.google.com/forms/d/e/1FAIpQLSdDfBD97d5KouCebE4b_naXs7ekTTLb6S_mY2etgT1HryktRQ/viewform",
        organizer:
          "Department of Data Science (COLOR CAPTURE Organizers)",
        capacity: "Not specified",
        additionalInfo:
          "Theme: Capture the assigned color as the main focus of your photo. Individual or team participation as per guidelines. Use smartphone or camera. Registration fees: ₹30 solo, ₹50 duo.",
        speakers: [],
