...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen text-black overflow-hidden bg-white">
      {/* Z-0: Light background */}
      <div className="absolute inset-0 bg-white z-0" />

      {/* Z-10: Animated grid */}
      <div className="absolute inset-0 z-10 bg-animated-grid" />
      ...
      <div className="relative z-30">
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            {/* Terminal mockup */}
            <div className="mt-6 max-w-2xl mx-auto bg-gray-100 rounded-lg p-4 font-mono text-sm text-gray-800 text-left">
        ...
        {/* Footer */}
        <footer className="bg-gray-100 border-t border-gray-300 py-8 mt-12 relative z-30">
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="text-gray-500 font-mono text-sm">
                &copy; {new Date().getFullYear()} DataTech Events | <span className="text-purple-600">v1.0.0</span>
              </div>
            </div>
          </div>
        </footer>
